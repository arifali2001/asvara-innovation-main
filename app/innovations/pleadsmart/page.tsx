...
// We've added a new component scrolltextreveal for 'text scrub' effect
export default function PleadSmartPage() {
  const data = content.innovations.pages.pleadsmart;
  ...
  const theme = {
    ...
    text: {
      ...
      bodyMain: `text-lg md:text-xl font-semibold leading-relaxed ${poppins.className}`,
    ...
    >
      ...
      <section className={theme.layout.section}>
        <div className={theme.layout.container}>
          ...
          >
            <h3
              className={`${theme.text.subHeading} mb-6 border-b ${theme.colors.border} pb-4`}
            >
              Core Capabilities
            </h3>
        ...
        <div className="max-w-3xl mx-auto">
          <FadeIn threshold="80%">
            ...
            <p className={`${theme.text.bodyMain} mb-10`}>
              Join the future of legal work with PleadSmart.
            </p>
